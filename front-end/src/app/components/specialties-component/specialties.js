var app = angular.module('myApp', []);
        app.controller('myCtrl', function ($scope) {
            ...
            $scope.specialties = [
                { id: 1, name: "Anestesiología", description: "Es usada para la intervención en procedimientos quirúrgicos sino  también para el manejo del dolor mediante el conocimiento de técnicas farmacológicas de analgesia en pacientes de diversas especies." },
                ...
                { id: 4, name: "Dermatología", description: "Esta enfocada en grandes o en pequeñas especies, ya que la anatomía y el manejo farmacológico varía según la especie a tratar." },
